...
# NOTE: For model inference, we currently require the large sample approximation
# be valid. Roughly, this means that the error degrees of freedom > 30.
# Clearly, that is not the case here, so our estimates are likely to be way
# off. But, as an example, it is still instructive.
